	    ...
	    methods: {
	        addlist: function addlist() {
	            ...
	            if (this.currentUser != null) {
	                _leancloudStorage2.default.User.current().set('myTodos', this.todolist);
	                _leancloudStorage2.default.User.current().set('newtodo', this.newTodo);
	                _leancloudStorage2.default.User.current().save();
	            }
	        },
	        ...
	        getCurrentUser: function getCurrentUser() {
	            if (_leancloudStorage2.default.User.current()) {
	                var _AV$User$current = _leancloudStorage2.default.User.current(),
	                    ...
	                    _AV$User$current$attr = _AV$User$current.attributes,
	                    username = _AV$User$current$attr.username,
	                    myTodos = _AV$User$current$attr.myTodos,
	                    newtodo = _AV$User$current$attr.newtodo;
